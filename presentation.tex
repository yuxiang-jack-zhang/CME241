...
\textbf{Convergence of Tabular SARSA}:\\[0.3em]
...
\begin{frame}[allowframebreaks]{Speaker Notes: Slide 12 -- SARSA vs.~Q-Learning}
...
\begin{frame}[allowframebreaks]{Speaker Notes: Slide 13 -- SARSA in the TD Spectrum}
\textbf{[Patrick speaks -- 1 min]}\\
...
\begin{frame}[allowframebreaks]{Speaker Notes: Slide 14 -- SARSA: Theoretical Guarantees}
\textbf{[Patrick speaks -- 1 min]}\\
``There is a convergence theorem for tabular SARSA. Under two conditions -- GLIE exploration and Robbins-Monro step sizes -- SARSA converges to the true optimal Q function.''\\[0.5em]
...
\begin{frame}[allowframebreaks]{Speaker Notes: Slide 15 -- SARSA Implementation}
\textbf{[Patrick speaks -- 1.5 min]}\\
